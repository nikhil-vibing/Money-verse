# Ninja Money-verse — Masters Research Brief
...
- **Application to Ninja Money-verse:** Teach compounding, diversification, and risk via visual abstractions (growing "saplings" for compound interest, sorting coloured tokens for diversification) **before** introducing formal terms.
...
- **Application to Ninja Money-verse:** Daily *market open* ritual — 3-5 min morning loop (check portfolio, claim insight, one micro-lesson). Streaks track financial habits, not lessons. Forgiveness via in-world "vacation days."
...
- **Application to Ninja Money-verse:** Skill tree organised by domain (Budgeting → Banking → Investing → Taxes → Insurance → Retirement). Cannot unlock the next *district* until in-game competency is proven.
...
- **Application to Ninja Money-verse:** All currency in INR; instruments grounded in Indian reality. 100% free core game. Treat the player as a future evangelist.
...
- **Application to Ninja Money-verse:** In-game NPC quests mirror IWT scripts. Auto-SIP is a literal building the player constructs. Game rewards systems-thinking, not penny-pinching.
...
- **Application to Ninja Money-verse:** Authored NPCs with schedules and dialog that responds to financial state. Parallel vectors: career, business, investing, real estate, philanthropy. Free updates as a brand promise.
...
- **Application to Ninja Money-verse:** Economy advances with skill, not time. Market events are visible and avoidable. Active inputs during financial decisions keep turn-based learning kinetic.
...
- **Application to Ninja Money-verse:** Assist Mode for finance — slower market ticks, hint NPCs, exposed math, optional tutorial replays. Forgiveness mechanics; never silently fail.
...
- **Application to Ninja Money-verse:** Financial decisions ripple through the world. Active mini-games inside otherwise passive financial moments (rhythm-game negotiation, e.g.).
...
- **Application to Ninja Money-verse:** No confetti on speculative wins. Celebrate *consistency*, not transactions. Show drawdown alongside gains. No fake urgency.
...
- 100% free core (Varsity / Khan / original Ninja Money-verse promise).
...
- **Where we deviate:** We are *more aggressive* than the original Ninja Money-verse on (a) Indian-context grounding (currency, instruments, festivals), and (b) explicit anti-Robinhood rules; the original markets itself as "Get rich or die trying" — we tone that down to avoid the speculative framing.
